    ...
    extend: {
      ...
      colors: {
        brand: {
          ...
          600: colors.blue[600], // check if can overwrite
          700: colors.blue[700], // check if can overwrite
        },
        foreground: {
          DEFAULT: "oklch(var(--black-900) / <alpha-value>)",
          primary: "oklch(var(--brand-700) / <alpha-value>)",
          success: colors.green[700], // check if can overwrite
          danger: colors.red[600], // check if can overwrite
          warning: colors.yellow[600], // check if can overwrite
        },
        background: {
